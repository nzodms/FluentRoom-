...
/**
 * Shell de l'app connectée : header desktop + bottom nav mobile,
 * colonne centrale mobile-first.
 */
      ...
      <header className="sticky top-0 z-40 glass border-b border-ink/5">
        <div className="mx-auto flex h-14 max-w-5xl items-center justify-between px-4 md:h-16 md:px-6">
          ...
          <Link
            href="/app/settings"
            aria-label="Réglages"
            className="grid size-9 place-items-center rounded-full text-ink-soft hover:bg-ink/5 transition-colors"
          >
